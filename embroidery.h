...
#define EMB_LINE        4
#define EMB_POINT       5
#define EMB_POLYGON     6
#define EMB_POLYLINE    7
#define EMB_RECT        8
#define EMB_SPLINE      9
...
EMB_PUBLIC EmbPathObject* embPathObject_create(EmbPointList* pointList, EmbGeometryArray* flagList, EmbColor color, int lineType);
