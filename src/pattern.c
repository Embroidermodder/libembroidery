 ...
 */
int
embp_color_count(EmbPattern *pattern, EmbColor startColor)
{
    int colors = 0, i;
 ...
 */
void
embp_details(EmbPattern *pattern)
{
...
void
embp_lengthHistogram(EmbPattern *pattern, int *bin, int NUMBINS)
{
    int i;
...
int
embp_realStitches(EmbPattern *pattern)
{
    int i;
    EmbArray *sts = pattern->stitch_list;
    int real_stitches = 0;
...
int
embp_jumpStitches(EmbPattern *pattern)
{
    int i;
    EmbArray *sts = pattern->stitch_list;
    int jump_stitches = 0;
...
int
embp_trimStitches(EmbPattern *pattern)
{
    int i;
    EmbArray *sts = pattern->stitch_list;
    int trim_stitches = 0;
 ...
 */
int
embp_real_count(EmbPattern *pattern)
{
    int i;
    int total = 0;
    for (i = 0; i < pattern->stitch_list->count; i++) {
...
EmbReal
embp_longest_stitch(EmbPattern *pattern)
{
...
EmbReal
embp_shortest_stitch(EmbPattern *pattern)
{
    if (pattern->stitch_list->count < 2) {
        return 0.0;
    }
 ...
 */
int
embp_count_type(EmbPattern *pattern, int flag)
{
    int i;
    int total = 0;
    for (i = 0; i < pattern->stitch_list->count; i++) {
